...
describe('baseOrderBy()', () => {
  describe('sorting flat arrays', () => {
    ...
    describe('alphanumerics', () => {
      ...
      describe('alphanumeric strings containing whitespace', () => {
        const origArray = ['img199', 'img 99', 'imga99', 'imgz 99', 'imgb99', 'imgz199'];
        const sortArray = ['img 99', 'img199', 'imga99', 'imgb99', 'imgz 99', 'imgz199'];
    ...
    describe('datetime', () => {
      describe('similar dates', () => {
        const origArray = ['10/12/2008', '10/11/2008', '10/11/2007', '10/12/2007'];
        const sortArray = ['10/11/2007', '10/12/2007', '10/11/2008', '10/12/2008'];
      ...
      describe('similar dates', () => {
        const origArray = ['01/01/2008', '01/10/2008', '01/01/1992', '01/01/1991'];
        const sortArray = ['01/01/1991', '01/01/1992', '01/01/2008', '01/10/2008'];
      ...
      describe('custom date format', () => {
        const origArray = ['2/15/2009 1:45 PM', '1/15/2009 1:45 PM', '2/15/2009 1:45 AM'];
        const sortArray = ['1/15/2009 1:45 PM', '2/15/2009 1:45 AM', '2/15/2009 1:45 PM'];
      ...
      describe('iSO8601-ish YYYY-MM-DD hh:mm:ss - which does not parse into a Date instance', () => {
        const origArray = ['2010-06-15 13:45:30', '2009-06-15 13:45:30', '2009-01-15 01:45:30'];
        const sortArray = ['2009-01-15 01:45:30', '2009-06-15 13:45:30', '2010-06-15 13:45:30'];
    ...
    describe('version number strings', () => {
      ...
      describe('more version numbers', () => {
        const origArray = ['1.19.100', '1.12.1', '1.1.10', '1.2.54', '2.0.1', '0.9.1'];
        const sortArray = ['0.9.1', '1.1.10', '1.2.54', '1.12.1', '1.19.100', '2.0.1'];
    ...
    describe('numerics', () => {
      ...
      describe('scientific notation', () => {
        const origArray = ['1.528535047e5', '1.528535047e7', '1.52e15', '1.528535047e3', '1.59e-3'];
        const sortArray = ['1.59e-3', '1.528535047e3', '1.528535047e5', '1.528535047e7', '1.52e15'];
      ...
      describe('numerics with prepended zero and optional trailing characters', () => {
        const origArray = ['05', '06', '07*', '08A', '09 B', '10', '11', '12A', '13'];
        const sortArray = ['05', '06', '07*', '08A', '09 B', '10', '11', '12A', '13'];
    ...
    describe('filenames', () => {
      ...
      describe('complex filenames ordered by extension and name', () => {
        ...
        it(`${origArray.toString()} should be returned as ${sortArray.toString()}`, () => {
          expect(
            baseOrderBy(origArray, [(v: any) => v.split('.').pop(), (v: any) => v], [])
          ).toEqual(sortArray);
        });
      });
    ...
    describe('unicode', () => {
      ...
      describe('sorting umlauts characters Ä, Ö, Ü', () => {
        const origArray = [
          'Udet',
          '\xDCbelacker',
          'Uell',
    ...
    describe('descending support', () => {
      describe('descending pre-sorted array', () => {
        ...
        it(`${origArray.toString()} should be returned as ${sortArray.toString()}`, () => {
          expect(baseOrderBy(origArray, [(v: any) => v], ['desc'])).toEqual(sortArray);
        });
      });
      ...
      describe('ascending pre-sorted array', () => {
        ...
        it(`${origArray.toString()} should be returned as ${sortArray.toString()}`, () => {
          expect(baseOrderBy(origArray, [(v: any) => v], ['asc'])).toEqual(sortArray);
        });
      });
  ...
  describe('sorting array of objects', () => {
    it('should return array in original order (stable sort)', () => {
      ...
      expect(baseOrderBy(origArray, [(value: any) => value.user], [])).toEqual(sortArray);
    });
    ...
    it('should order by user ascending (default) and age ascending (default) case insensitive', () => {
      ...
      expect(baseOrderBy(origArray, [(v: any) => v.user, (v: any) => v.age], [])).toEqual(
        sortArray
      );
    });
    ...
    it('should order by user ascending (default) and age ascending', () => {
      ...
      expect(baseOrderBy(origArray, ['user', 'age'], ['asc'])).toEqual(sortArray);
    });
    ...
    it('should order by user ascending (default) and age descending', () => {
      ...
      expect(baseOrderBy(origArray, ['user', 'age'], ['asc', 'desc'])).toEqual(sortArray);
    });
    ...
    it('should order by user descending (default) and age ascending (default) case insensitive', () => {
      ...
      expect(
        baseOrderBy(origArray, [(v: any) => v.user, (v: any) => v.age], ['desc', 'asc'])
      ).toEqual(sortArray);
    });
    ...
    it('should order by user descending and age ascending (default)', () => {
      ...
      expect(baseOrderBy(origArray, ['user', 'age'], ['desc', 'asc'])).toEqual(sortArray);
    });
    ...
    it('should order by user ascending and age ascending', () => {
      ...
      expect(baseOrderBy(origArray, ['user', 'age'], ['asc', 'asc'])).toEqual(sortArray);
    });
    ...
    it('should order by user ascending (default) and age ascending (default) using functional identifiers', () => {
      ...
      expect(
        baseOrderBy(origArray, [(v: any) => v.datetime, (v: any) => v.ip], ['desc', 'asc'])
      ).toEqual(sortArray);
    });
  });
  ...
  describe('sorting nested arrays', () => {
    ...
    it('should order by first element ascending (default) and second element descending', () => {
      ...
      expect(baseOrderBy(origArray, ['0', '1'], ['asc', 'desc'])).toEqual(sortArray);
    });
    ...
    it('should order by first element ascending and second element ascending (default) case insensitive', () => {
      ...
      expect(baseOrderBy(origArray, [(v: any) => v[0], (v: any) => v[1]], ['asc'])).toEqual(
        sortArray
      );
    });
    ...
    it('should order by first element descending and second element ascending', () => {
      ...
      expect(baseOrderBy(origArray, ['0', '1'], ['desc', 'asc'])).toEqual(sortArray);
    });
    ...
    it('should order by first element ascending (default) and second element ascending (default) using functional identifiers', () => {
      ...
      expect(baseOrderBy(origArray, [(v: any) => v[0], (v: any) => v[1]], [])).toEqual(sortArray);
    });
  });
});

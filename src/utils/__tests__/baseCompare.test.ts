...
describe('baseCompare()', () => {
  ...
  describe('datetime', () => {
    ...
    describe('date.toString(), Date.toLocaleString()', () => {
      const origArray = ['Saturday, July 3, 2010', 'Monday, August 2, 2010', 'Monday, May 3, 2010'];
      const sortArray = ['Monday, May 3, 2010', 'Saturday, July 3, 2010', 'Monday, August 2, 2010'];
  ...
  describe('rosetta code natural sort small test set', () => {
    ...
    describe('title sorts', () => {
      const origArray = ['The Wind in the Willows', 'The 40th step more', 'The 39 steps', 'Wanda'];
      const sortArray = ['The 39 steps', 'The 40th step more', 'The Wind in the Willows', 'Wanda'];

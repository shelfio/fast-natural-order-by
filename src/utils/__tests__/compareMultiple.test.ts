...
describe('compareMultiple()', () => {
  ...
  describe('mixed order', () => {
    it('should call compareValues() twice and return result without changing order (-1)', () => {
      ...
      expect(compareMultiple(recordA, recordB, ['desc', 'asc'])).toBeLessThan(0);
    });
    ...
    it('should call compareValues() twice and return result without changing order (1)', () => {
      ...
      expect(compareMultiple(recordA, recordB, ['asc', 'desc'])).toBeGreaterThan(0);
    });
  });
  ...
  describe('order function', () => {
    it('should call compareValues() and order() once and return result of order()', () => {
      ...
      expect(compareMultiple(recordA, recordB, ['desc', order])).toBeLessThan(0);
      expect(order).toHaveBeenCalledTimes(1);
      expect(order).toHaveBeenCalledWith(recordA.values[1].value, recordB.values[1].value);
    });
    ...
    it('should call order() and compareValues() once and return result of compareValues()', () => {
      ...
      expect(order).toHaveBeenCalledTimes(1);
      expect(order).toHaveBeenCalledWith(recordA.values[0].value, recordB.values[0].value);
    });
  });
});
